...
# NOTE: Anthropic retires older model IDs over time (see
# https://platform.claude.com/docs/en/about-claude/model-deprecations).
# claude-3-5-sonnet-20241022 was retired 28 Oct 2025 and
# claude-3-haiku-20240307 was retired 20 Apr 2026 -- both would fail with a
# 404/not_found error, exactly like the Groq issue. Using the current
# active model line as of this update.
ANTHROPIC_MODEL_SONNET = "claude-sonnet-5"
ANTHROPIC_MODEL_HAIKU = "claude-haiku-4-5-20251001"
DEFAULT_ANTHROPIC_MODEL = ANTHROPIC_MODEL_SONNET

# Groq models
# NOTE: Groq periodically deprecates/rotates its hosted models (see
# https://console.groq.com/docs/deprecations). llama-3.3-70b-versatile was
# deprecated by Groq (decommissioned 16 Aug 2026); openai/gpt-oss-120b is
# Groq's official recommended replacement and supports native tool-calling,
# which this app relies on for the chat agent. If Groq deprecates this one
# too in the future, update GROQ_MODEL_PRIMARY below (or pick a different
# option in the sidebar's Groq Model selector).
GROQ_MODEL_PRIMARY = "openai/gpt-oss-120b"
GROQ_MODEL_FAST = "openai/gpt-oss-20b"
GROQ_MODEL_ALT = "qwen/qwen3.6-27b"
DEFAULT_GROQ_MODEL = GROQ_MODEL_PRIMARY
